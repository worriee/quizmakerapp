    ...
    <div className="flex flex-col items-center justify-center h-full p-6 animate-in fade-in zoom-in duration-300">
      <div className="bg-white border border-[#7b9acc]/20 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-xl space-y-8">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-serif italic text-[#7b9acc]">Quiz Configuration</h2>
          <p className="text-black/50 text-sm">Customize your challenge to master the topic</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <label className="text-sm font-bold text-black/70 uppercase tracking-wider">Number of Questions</label>
              <span className="text-[#7b9acc] font-bold text-lg">{itemCount}</span>
            </div>
            <input 
              type="range" 
              min="3" 
          ...
          {/* Difficulty */}
          <div className="space-y-3">
            <label className="text-sm font-bold text-black/70 uppercase tracking-wider block">Difficulty Level</label>
